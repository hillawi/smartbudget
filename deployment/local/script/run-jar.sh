...
java -jar \
-DSMART_BUDGET_DOC_INPUT_PATH="${SMART_BUDGET_DOC_INPUT_PATH}" \
-DSMART_BUDGET_DB_USERNAME="${SMART_BUDGET_DB_USERNAME}" \
-DSMART_BUDGET_DB_PASSWORD="${SMART_BUDGET_DB_PASSWORD}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_ADMINISTRATION="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_ADMINISTRATION}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_AMAZON="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_AMAZON}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_BANKING="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_BANKING}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_CLOTHING="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_CLOTHING}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_ENTERTAINMENT="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_ENTERTAINMENT}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_FAMILY_ALLOWANCES="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_FAMILY_ALLOWANCES}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_FAMILY_SUPPORT="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_FAMILY_SUPPORT}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_FOOD="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_FOOD}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_HEALTHCARE="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_HEALTHCARE}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_HOUSING="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_HOUSING}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_HOUSING_RENT="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_HOUSING_RENT}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_MISCELLANEOUS="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_MISCELLANEOUS}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_PAYPAL="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_PAYPAL}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_PERSONAL="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_PERSONAL}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_SALARY="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_SALARY}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_SAVINGS="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_SAVINGS}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_SCHOOL="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_SCHOOL}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_SPORT="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_SPORT}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_TAXES="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_TAXES}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_TELECOM="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_TELECOM}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_TRANSPORT="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_TRANSPORT}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_TRAVEL="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_TRAVEL}" \
-DSMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_UTILITIES="${SMART_BUDGET_CATEGORIZATION_EXTRA_KEYWORDS_UTILITIES}" \
-Dspring.profiles.active=prod \
"$SMART_BUDGET_BIN_DIR"/smart-budget.jar > "$SMART_BUDGET_BIN_DIR"/smart-budget.log &
